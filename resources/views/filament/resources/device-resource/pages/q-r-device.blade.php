...
<h1>{{ __('module_names.devices.label') }}: {{ $record->nev }}</h1>
<div id="printableArea">
    {!! QrCode::size(300)->backgroundColor(255, 90, 0)->generate(env('APP_URL') . route('filament.admin.resources.devices.view', $record->id)) !!}
</div>
<a
